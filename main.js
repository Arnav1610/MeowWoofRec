function startClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/ByO8fI7OP/model.json', modelReady);
}
...
function gotResults(error, results) {
    if (error) {
        ...
        img2 = document.getElementById('blank');
